-- Migration: Redefine process_granular_payment with p_discounts support, direct original_payment_id reconciliation, anti-concurrency check, and smart leftovers cleanup.
...
BEGIN
  ...
  -- 6. CANCEL placeholder PENDIENTE payments (instead of DELETE to preserve FK references)

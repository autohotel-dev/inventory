...
export function ExportManager() {
  ...
  const downloadCSV = (data: Record<string, string | number | boolean | null>[], filename: string) => {
  ...
  const downloadExcel = (data: Record<string, string | number | boolean | null>[], filename: string) => {
  ...
  const downloadPDF = (data: Record<string, string | number | boolean | null>[], filename: string, dataType: string) => {

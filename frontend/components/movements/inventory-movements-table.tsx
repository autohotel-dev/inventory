...
export function InventoryMovementsTable() {
  ...
  // Memoizing the filtered movements array prevents expensive O(N) string matching and
  ...
  const {
    ...
    // ⚡ Bolt Performance Optimization:
    // Consolidating multiple .filter().length operations into a single O(N) pass over the array
    // reduces redundant array iterations and improves rendering performance for large lists.

...
const EVENT_ICONS: Record<string, React.ReactNode> = {
  ...
  VALET_PAYMENT_COLLECTED: <Activity className="h-4 w-4" />,
  REMINDER_SENT: <Activity className="h-4 w-4" />,
  PAYMENT_CORROBORATED: <ShieldCheck className="h-4 w-4" />,
  PAYMENT_REGISTERED: <CheckCircle className="h-4 w-4" />,
  PAYMENT_ADJUSTED: <CreditCard className="h-4 w-4" />,
  EXTRAS_REQUESTED: <Activity className="h-4 w-4" />,
  ...
  EXTRA_HOUR_PAID: <Activity className="h-4 w-4" />,
  EXTRA_PERSON_ADDED: <UserPlus className="h-4 w-4" />,
  EXTRA_PERSON_PAID: <Activity className="h-4 w-4" />,
  ...
  CONSUMPTION_PAID: <Activity className="h-4 w-4" />,

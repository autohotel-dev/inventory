...
const EVENT_ICONS: Record<string, React.ReactNode> = {
  ...
  // Nuevos eventos de trazabilidad
  ROOM_ASSIGNED: <PlusCircle className="h-4 w-4" />,
  VALET_NOTIFICATION_SENT: <Activity className="h-4 w-4" />,
  VALET_NOTIFICATION_RECEIVED: <CheckCircle className="h-4 w-4" />,
  VALET_ENTRY_ACCEPTED: <Car className="h-4 w-4" />,
  VALET_VEHICLE_REGISTERED: <Car className="h-4 w-4" />,
  VALET_FORM_SUBMITTED: <CheckCircle className="h-4 w-4" />,
  VALET_PAYMENT_COLLECTED: <Banknote className="h-4 w-4" />,
  REMINDER_SENT: <AlertTriangle className="h-4 w-4" />,
  PAYMENT_CORROBORATED: <ShieldCheck className="h-4 w-4" />,
  PAYMENT_REGISTERED: <CheckCircle className="h-4 w-4" />,
  PAYMENT_ADJUSTED: <Receipt className="h-4 w-4" />,
  EXTRAS_REQUESTED: <AlertTriangle className="h-4 w-4" />,
  EXTRAS_ACCEPTED: <Car className="h-4 w-4" />,
  EXTRAS_FORM_SUBMITTED: <CheckCircle className="h-4 w-4" />,
  EXTRA_HOUR_ADDED: <Timer className="h-4 w-4" />,
  EXTRA_HOUR_PAID: <Banknote className="h-4 w-4" />,
  EXTRA_PERSON_ADDED: <UserPlus className="h-4 w-4" />,
  EXTRA_PERSON_PAID: <Banknote className="h-4 w-4" />,
  PERSON_ADDED: <UserPlus className="h-4 w-4" />,
  PERSON_REMOVED: <XCircle className="h-4 w-4" />,
  CONSUMPTION_ACCEPTED: <ShoppingBag className="h-4 w-4" />,
  CONSUMPTION_DELIVERED: <CheckCircle className="h-4 w-4" />,
  CONSUMPTION_PAID: <Banknote className="h-4 w-4" />,
  CONSUMPTION_CANCELLED: <XCircle className="h-4 w-4" />,
  CHECKOUT_INITIATED: <DoorOpen className="h-4 w-4" />,
...
const ACTION_LABELS: Record<string, string> = {
  ...
  VALET_NOTIFICATION_SENT: "Notificación Enviada a Cocheros",
  VALET_NOTIFICATION_RECEIVED: "Cochero Recibió Notificación",
  VALET_ENTRY_ACCEPTED: "Cochero Aceptó Entrada",
  VALET_VEHICLE_REGISTERED: "Vehículo Registrado por Cochero",
  VALET_FORM_SUBMITTED: "Formulario Enviado desde App Móvil",
  VALET_PAYMENT_COLLECTED: "Pago Recaudado por Cochero",
  REMINDER_SENT: "Recordatorio Enviado a Cochero",
  PAYMENT_CORROBORATED: "Pago Corroborado por Recepción",
  PAYMENT_REGISTERED: "Pago Registrado y Confirmado",
  PAYMENT_ADJUSTED: "Pago Ajustado por Recepción",
  EXTRAS_REQUESTED: "Extras Solicitados a Cochero",
  EXTRAS_ACCEPTED: "Extras Aceptados por Cochero",
  EXTRAS_FORM_SUBMITTED: "Formulario de Extras Enviado",
  EXTRA_HOUR_ADDED: "Hora Extra Añadida",
  EXTRA_HOUR_PAID: "Hora Extra Pagada",
  EXTRA_PERSON_ADDED: "Persona Extra Añadida",
  EXTRA_PERSON_PAID: "Persona Extra Pagada",
  PERSON_ADDED: "Persona Añadida",
  PERSON_REMOVED: "Persona Removida",
  CONSUMPTION_ACCEPTED: "Consumo Aceptado por Cochero",

...
export type FlowEventType =
  ...
  | "ROOM_STATUS_CHANGED"
  | "ROOM_CHANGED"
  // Cochero - Flujo de Entrada
  | "VALET_NOTIFICATION_SENT"
  | "VALET_NOTIFICATION_RECEIVED"
  | "VALET_ENTRY_ACCEPTED"
  | "VALET_VEHICLE_REGISTERED"
  | "VALET_FORM_SUBMITTED"
  ...
  // Extras - Flujo completo (sin recordatorio)
  | "EXTRAS_REQUESTED"
  | "EXTRAS_NOTIFICATION_SENT"
  | "EXTRAS_NOTIFICATION_RECEIVED"
  | "EXTRAS_ACCEPTED"
  | "EXTRAS_FORM_SUBMITTED"
  | "EXTRAS_CORROBORATED"
  | "EXTRAS_REGISTERED"
  | "EXTRAS_ADJUSTED"
  | "EXTRA_HOUR_ADDED"
...
const EVENT_CATEGORY_MAP: Record<string, FlowEventCategory> = {
  ...
  ROOM_CHANGED: "ROOM",
  VALET_NOTIFICATION_SENT: "VALET",
  VALET_NOTIFICATION_RECEIVED: "VALET",
  VALET_ENTRY_ACCEPTED: "VALET",
  VALET_VEHICLE_REGISTERED: "VALET",
  VALET_FORM_SUBMITTED: "VALET",
  ...
  EXTRAS_NOTIFICATION_SENT: "EXTRAS",
  EXTRAS_NOTIFICATION_RECEIVED: "EXTRAS",
  EXTRAS_ACCEPTED: "EXTRAS",
  EXTRAS_FORM_SUBMITTED: "EXTRAS",
  EXTRAS_CORROBORATED: "EXTRAS",
  EXTRAS_REGISTERED: "EXTRAS",
  EXTRAS_ADJUSTED: "EXTRAS",
